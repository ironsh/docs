...
The `egress-rules.yaml` file corresponds to the `allowlist` transform in the full [iron-proxy configuration](/legacy/reference/configuration). It supports three types of rules.
