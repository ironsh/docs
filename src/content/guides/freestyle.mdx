...
Freestyle VMs do not include the iptables `owner` match module (`xt_owner`), so egress control is limited to DNS-based interception only. See [Egress Control Limitations](#egress-control-limitations) for details.
</Callout>
