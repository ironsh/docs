...
<Cards>
  <Cards.Card title="Configuration Reference" href="/legacy/reference/configuration" arrow />
  <Cards.Card title="Docker Deployment" href="/guides/docker" arrow />
  <Cards.Card title="Routing Traffic to the Proxy" href="/guides/routing" arrow />
  <Cards.Card title="Architecture" href="/legacy/reference/architecture" arrow />
</Cards>
