...
This is the fastest way to duplicate a running environment. See the [`fork` CLI reference](/reference/cli#fork) for all available flags.

## Further Reading

- [Snapshots API reference](/reference/api#snapshots) — create, list, get, and delete snapshots via the REST API.
- [Snapshots CLI reference](/reference/cli#snapshots) — manage snapshots from the command line.
- [`fork` CLI reference](/reference/cli#fork) — one-command VM duplication.
