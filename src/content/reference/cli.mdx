...
Manage VM snapshots. Snapshots capture a VM's overlay at a point in time with zero downtime. Restoring a snapshot creates a new VM — the original is untouched.
