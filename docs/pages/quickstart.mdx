---
title: "Quickstart"
description: "Run iron-proxy locally with Docker Compose and intercept your first request."
---

# Quickstart

Run iron-proxy locally with Docker Compose. By the end, you have a running proxy that allowlists specific hosts, blocks everything else, and swaps proxy tokens for real secrets. The setup uses the [docker-compose example](https://github.com/ironsh/iron-proxy/tree/main/examples/docker-compose) from the iron-proxy repo.
