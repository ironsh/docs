...
MCP policies enforce default-deny tool allowlists on Streamable HTTP MCP servers. See [MCP Interception](/reference/mcp-interception) for the runtime semantics, JSON-RPC handling, and `tools/list` filtering behavior.
