...
This is the pattern used in the [Amazon ECS guide](/deploy/ecs), where iron-proxy runs as a daemon service on each EC2 instance and workload containers share the host's Docker bridge network.
...
This is the pattern used in the [bare metal guide](/deploy/bare-metal), the [Daytona guide](/deploy/daytona), the [Freestyle guide](/deploy/freestyle), and the [GitHub Actions guide](/deploy/github-actions).
