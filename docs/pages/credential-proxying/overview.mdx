...
| An AWS SigV4 signature | [AWS Request Signing](/credential-proxying/aws-auth) | An AWS access key and secret, or AWS workload identity credentials. |
| A Google service-account access token | [GCP Service Accounts](/credential-proxying/gcp-auth) | A service-account JSON keyfile, or GCP workload identity credentials. |
