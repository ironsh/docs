...
Run iron-proxy directly on a Linux host: a physical server, a cloud VM, or any other machine where you control the network stack. This is the [embedded in a VM or sandbox](/reference/deployment-methods#embedded-in-a-vm-or-sandbox) deployment pattern.
